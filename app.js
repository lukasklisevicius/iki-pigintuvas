...
function balloonsGame() {
    ...
    gsap.set('#container0,#container1', {
        opacity: 0
    })
    gsap.to('#container0,#container1', 1, {
        opacity: 1,
        delay: 1
    })
    gsap.set('#container0,#container1', {
    ...
    gsap.to('#container0,#container1', 2, {
        y: 0,
        delay: 1
    })
    ...
    gsap.to(`#ball0,#ball1,#ball2,#ball3,#ball4,#ball4,#ball5,#ball6,#ball7,#ball8,#ball9`, 1, {
        opacity: 1
    })
...
function renderEl() {
    ...
    for (let i = 0; i < 10; i++) {
        ...
        if (i < 3) {
            con0.appendChild(ball)
        }
        if (i > 2 && i < 5) {
            con1.appendChild(ball)
        }
        if (i > 4 && i < 7) {
            con0.appendChild(ball)
        }
